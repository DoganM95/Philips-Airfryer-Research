...
.field private final callFactory:Lr/e$a;
...
# direct methods
.method public constructor <init>(Lretrofit2/RequestFactory;[Ljava/lang/Object;Lr/e$a;Lretrofit2/Converter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    iput-object p3, p0, Lretrofit2/OkHttpCall;->callFactory:Lr/e$a;
...
.method private createRawCall()Lr/e;
    .locals 3
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/OkHttpCall;->callFactory:Lr/e$a;
    ...
    invoke-virtual {v1, v2}, Lretrofit2/RequestFactory;->create([Ljava/lang/Object;)Lr/c0;

    move-result-object v1

    invoke-interface {v0, v1}, Lr/e$a;->a(Lr/c0;)Lr/e;
...
.method private getRawCall()Lr/e;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    iget-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Lr/e;
    ...
    :cond_3
    :try_start_0
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->createRawCall()Lr/e;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Lr/e;
    :try_end_0
...
.method public clone()Lretrofit2/OkHttpCall;
    ...
    iget-object v3, p0, Lretrofit2/OkHttpCall;->callFactory:Lr/e$a;

    iget-object v4, p0, Lretrofit2/OkHttpCall;->responseConverter:Lretrofit2/Converter;

    invoke-direct {v0, v1, v2, v3, v4}, Lretrofit2/OkHttpCall;-><init>(Lretrofit2/RequestFactory;[Ljava/lang/Object;Lr/e$a;Lretrofit2/Converter;)V
...
.method public enqueue(Lretrofit2/Callback;)V
    ...
    iput-object v2, p0, Lretrofit2/OkHttpCall;->rawCall:Lr/e;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-static {v0, v1}, Lcom/google/firebase/perf/network/FirebasePerfOkHttpClient;->enqueue(Lr/e;Lr/f;)V
...
.method public execute()Lretrofit2/Response;
    ...
    .line 4
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->getRawCall()Lr/e;
    ...
    .line 8
    :cond_0
    invoke-static {v0}, Lcom/google/firebase/perf/network/FirebasePerfOkHttpClient;->execute(Lr/e;)Lr/e0;

    move-result-object v0

    invoke-virtual {p0, v0}, Lretrofit2/OkHttpCall;->parseResponse(Lr/e0;)Lretrofit2/Response;
...
.method public parseResponse(Lr/e0;)Lretrofit2/Response;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v0}, Lretrofit2/OkHttpCall$ExceptionCatchingResponseBody;-><init>(Lr/f0;)V
    ...
    .line 8
    invoke-static {v0, p1}, Lretrofit2/Response;->success(Ljava/lang/Object;Lr/e0;)Lretrofit2/Response;
    ...
    :goto_1
    :try_start_1
    invoke-static {v0}, Lretrofit2/Utils;->buffer(Lr/f0;)Lr/f0;

    move-result-object v1

    .line 14
    invoke-static {v1, p1}, Lretrofit2/Response;->error(Lr/f0;Lr/e0;)Lretrofit2/Response;
...
.method public declared-synchronized request()Lr/c0;
    .locals 3
    ...
    invoke-interface {v0}, Lr/e;->request()Lr/c0;
...
.method public declared-synchronized timeout()Lokio/Timeout;
    ...
    invoke-interface {v0}, Lr/e;->timeout()Lokio/Timeout;
