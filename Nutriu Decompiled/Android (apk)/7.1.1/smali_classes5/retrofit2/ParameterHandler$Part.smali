...
# direct methods
.method public constructor <init>(Ljava/lang/reflect/Method;ILr/v;Lretrofit2/Converter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    iput-object p3, p0, Lretrofit2/ParameterHandler$Part;->headers:Lr/v;
...
.method public apply(Lretrofit2/RequestBuilder;Ljava/lang/Object;)V
    ...
    .line 2
    iget-object p2, p0, Lretrofit2/ParameterHandler$Part;->headers:Lr/v;

    invoke-virtual {p1, p2, v0}, Lretrofit2/RequestBuilder;->addPart(Lr/v;Lr/d0;)V
