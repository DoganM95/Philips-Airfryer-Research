...
.method public static a(Landroid/content/Context;Lcn/jpush/android/api/CustomMessage;)V
    ...
    iget-byte v2, p1, Lcn/jpush/android/api/CustomMessage;->platform:B
...
.method public static a(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;Ljava/lang/String;)V
    ...
    invoke-static {p0, v4, p2}, Lcn/jpush/android/af/a;->b(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0}, Lcn/jpush/android/af/a;->f(Landroid/content/Context;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {p0, v1}, Lcn/jpush/android/af/c;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lcn/jpush/android/af/c;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v4, p1}, Lcn/jpush/android/af/a;->a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
...
.method public a(Landroid/content/Context;Lcn/jpush/android/service/JPushMessageReceiver;Landroid/content/Intent;)V
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Lcn/jpush/android/helper/a$a;-><init>(Lcn/jpush/android/helper/a;Landroid/content/Context;Lcn/jpush/android/service/JPushMessageReceiver;Landroid/content/Intent;)V

    const-string p2, "JMessageReceiverHelper"

    invoke-static {p1, p2, v0}, Lcn/jpush/android/helper/JCoreHelper;->majorExecutor(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Runnable;)V
