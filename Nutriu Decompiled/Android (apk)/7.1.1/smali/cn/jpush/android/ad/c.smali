.class public Lcn/jpush/android/ad/c;
.super Ljava/lang/Object;


# static fields
.field private static volatile a:Lcn/jpush/android/ad/c;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcn/jpush/android/ad/c;->d:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcn/jpush/android/ad/c;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Lcn/jpush/android/ad/c;->e:Ljava/util/concurrent/atomic/AtomicBoolean;

    return-void
.end method

.method public static a()Lcn/jpush/android/ad/c;
    .locals 2

    sget-object v0, Lcn/jpush/android/ad/c;->a:Lcn/jpush/android/ad/c;

    if-nez v0, :cond_1

    sget-object v0, Lcn/jpush/android/ad/c;->d:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcn/jpush/android/ad/c;->a:Lcn/jpush/android/ad/c;

    if-nez v1, :cond_0

    new-instance v1, Lcn/jpush/android/ad/c;

    invoke-direct {v1}, Lcn/jpush/android/ad/c;-><init>()V

    sput-object v1, Lcn/jpush/android/ad/c;->a:Lcn/jpush/android/ad/c;
...
.method private a(Lcn/jpush/android/api/CallBackParams;)Ljava/lang/String;
    ...
    :cond_0
    :try_start_0
    iget-object v2, p1, Lcn/jpush/android/api/CallBackParams;->tags:Ljava/util/Set;
    ...
    iget-object p1, p1, Lcn/jpush/android/api/CallBackParams;->tags:Ljava/util/Set;
...
.method private a(Landroid/content/Context;IJ)V
    ...
    :cond_0
    const-string v0, "action - on send data over limit"

    :goto_0
    invoke-static {v1, v0}, Lcn/jpush/android/helper/Logger;->v(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p3, p4}, Lcn/jpush/android/ad/c;->a(J)Lcn/jpush/android/api/CallBackParams;
    ...
    :cond_1
    invoke-virtual {p0, p3, p4}, Lcn/jpush/android/ad/c;->b(J)V

    const/4 p3, 0x0

    invoke-direct {p0, p1, v0, p2, p3}, Lcn/jpush/android/ad/c;->a(Landroid/content/Context;Lcn/jpush/android/api/CallBackParams;IZ)V
...
.method private a(Landroid/content/Context;IJLandroid/content/Intent;)V
    ...
    const-string v1, "SetAliasAndTags finish : errorCode:"
    ...
    invoke-virtual {v2, p3, p4}, Lcn/jpush/android/ad/c;->b(J)V
    ...
    :try_start_0
    iget p4, v0, Lcn/jpush/android/api/CallBackParams;->action:I

    const/4 v2, 0x5

    if-ne p4, v2, :cond_2

    iget p4, v0, Lcn/jpush/android/api/CallBackParams;->protoType:I
    ...
    iput-object p5, v0, Lcn/jpush/android/api/CallBackParams;->tags:Ljava/util/Set;
    ...
    iget-object p5, v0, Lcn/jpush/android/api/CallBackParams;->tags:Ljava/util/Set;
    ...
    iput-object p4, v0, Lcn/jpush/android/api/CallBackParams;->alias:Ljava/lang/String;
...
.method private a(Landroid/content/Context;Lcn/jpush/android/api/CallBackParams;IZ)V
    ...
    const-string p4, "action - invokeUserCallback, errorCode:"
    ...
    iget p1, p2, Lcn/jpush/android/api/CallBackParams;->protoType:I

    if-nez p1, :cond_0

    iget-object p1, p2, Lcn/jpush/android/api/CallBackParams;->tagAliasCallBack:Lcn/jpush/android/api/TagAliasCallback;

    if-eqz p1, :cond_1

    iget-object p4, p2, Lcn/jpush/android/api/CallBackParams;->alias:Ljava/lang/String;

    iget-object p2, p2, Lcn/jpush/android/api/CallBackParams;->tags:Ljava/util/Set;
...
.method private c(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Lcn/jpush/android/ad/c;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lcn/jpush/android/ad/c;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget v2, Lcn/jpush/android/api/JPushInterface$ErrorCode;->TIMEOUT:I

    invoke-virtual {v1}, Ljava/lang/Long;->longValue()J

    move-result-wide v3

    invoke-direct {p0, p1, v2, v3, v4}, Lcn/jpush/android/ad/c;->a(Landroid/content/Context;IJ)V
...
.method public a(Landroid/content/Context;Landroid/content/Intent;)Lcn/jpush/android/api/JPushMessage;
    ...
    const-string v4, "parseTagAliasResponse2JPushMessage, errorCode:"
    ...
    invoke-static {v4, v3}, Lcn/jpush/android/helper/Logger;->v(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v0, v1}, Lcn/jpush/android/ad/c;->a(J)Lcn/jpush/android/api/CallBackParams;
    ...
    invoke-virtual {v5, v0, v1}, Lcn/jpush/android/ad/c;->b(J)V
    ...
    :try_start_0
    iget v5, v3, Lcn/jpush/android/api/CallBackParams;->action:I

    const/4 v6, 0x5

    if-ne v5, v6, :cond_2

    iget v5, v3, Lcn/jpush/android/api/CallBackParams;->protoType:I
    ...
    iput-object v5, v3, Lcn/jpush/android/api/CallBackParams;->tags:Ljava/util/Set;
    ...
    iget-object v5, v3, Lcn/jpush/android/api/CallBackParams;->tags:Ljava/util/Set;
    ...
    iput-object p2, v3, Lcn/jpush/android/api/CallBackParams;->alias:Ljava/lang/String;
    ...
    iget p1, v3, Lcn/jpush/android/api/CallBackParams;->sequence:I

    invoke-virtual {p2, p1}, Lcn/jpush/android/api/JPushMessage;->setSequence(I)V

    iget p1, v3, Lcn/jpush/android/api/CallBackParams;->protoType:I

    if-ne p1, v1, :cond_5

    iget p1, v3, Lcn/jpush/android/api/CallBackParams;->action:I

    if-ne p1, v0, :cond_4

    invoke-direct {p0, v3}, Lcn/jpush/android/ad/c;->a(Lcn/jpush/android/api/CallBackParams;)Ljava/lang/String;
    ...
    :cond_4
    iget-object p1, v3, Lcn/jpush/android/api/CallBackParams;->tags:Ljava/util/Set;
    ...
    :cond_5
    iget-object p1, v3, Lcn/jpush/android/api/CallBackParams;->alias:Ljava/lang/String;
...
.method public declared-synchronized a(Landroid/content/Context;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcn/jpush/android/ad/c;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v1, p0, Lcn/jpush/android/ad/c;->b:Lcn/jpush/android/service/TagAliasReceiver;
    ...
    iput-object v1, p0, Lcn/jpush/android/ad/c;->b:Lcn/jpush/android/service/TagAliasReceiver;
    ...
    iget-object p1, p0, Lcn/jpush/android/ad/c;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public a(Landroid/content/Context;JILandroid/content/Intent;)V
    ...
    invoke-virtual {v1}, Lcn/jpush/android/ad/c;->b()Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {p0, p1, p4, p2, p3}, Lcn/jpush/android/ad/c;->a(Landroid/content/Context;IJ)V
    ...
    invoke-direct/range {v0 .. v5}, Lcn/jpush/android/ad/c;->a(Landroid/content/Context;IJLandroid/content/Intent;)V

    :goto_0
    invoke-virtual {p0, p1}, Lcn/jpush/android/ad/c;->b(Landroid/content/Context;)V
...
.method public a(Landroid/content/Context;Ljava/lang/Long;Lcn/jpush/android/api/CallBackParams;)V
    ...
    invoke-direct {p0, p1}, Lcn/jpush/android/ad/c;->c(Landroid/content/Context;)V

    iget-object p1, p0, Lcn/jpush/android/ad/c;->c:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public declared-synchronized b(Landroid/content/Context;)V
    ...
    :try_start_1
    iget-object v0, p0, Lcn/jpush/android/ad/c;->b:Lcn/jpush/android/service/TagAliasReceiver;
    ...
    iput-object p1, p0, Lcn/jpush/android/ad/c;->b:Lcn/jpush/android/service/TagAliasReceiver;
    :try_end_1
