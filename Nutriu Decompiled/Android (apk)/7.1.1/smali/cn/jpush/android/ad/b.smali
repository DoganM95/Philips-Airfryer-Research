...
# static fields
.field private static volatile a:Lcn/jpush/android/ad/b;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcn/jpush/android/ad/b;->b:Ljava/lang/Object;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcn/jpush/android/ad/b;->c:Ljava/util/concurrent/ConcurrentHashMap;

    return-void
.end method

.method private a(Lorg/json/JSONObject;Lcn/jpush/android/ad/b$a;)Lcn/jpush/android/ad/b$a;
    .locals 4
    ...
    iget v0, p2, Lcn/jpush/android/ad/b$a;->a:I
    ...
    iget-object p1, p2, Lcn/jpush/android/ad/b$a;->d:Ljava/util/ArrayList;
    ...
    iput-object p1, p2, Lcn/jpush/android/ad/b$a;->e:Ljava/lang/String;
...
.method public static a()Lcn/jpush/android/ad/b;
    ...
    sget-object v0, Lcn/jpush/android/ad/b;->b:Ljava/lang/Object;
...
.method private a(Landroid/content/Context;ILcn/jpush/android/ad/b$a;)Z
    .locals 3
    ...
    iget p2, p3, Lcn/jpush/android/ad/b$a;->h:I

    if-nez p2, :cond_1

    add-int/2addr p2, v0

    iput p2, p3, Lcn/jpush/android/ad/b$a;->h:I

    iget p2, p3, Lcn/jpush/android/ad/b$a;->a:I

    iget-wide v1, p3, Lcn/jpush/android/ad/b$a;->c:J

    invoke-virtual {p0, p1, p2, v1, v2}, Lcn/jpush/android/ad/b;->a(Landroid/content/Context;IJ)Z
    ...
    :cond_0
    invoke-direct {p0, p1, p3}, Lcn/jpush/android/ad/b;->b(Landroid/content/Context;Lcn/jpush/android/ad/b$a;)Z
...
.method private a(Landroid/content/Context;Lcn/jpush/android/ad/b$a;)Z
    .locals 3
    ...
    iget v1, p2, Lcn/jpush/android/ad/b$a;->g:I

    iget p2, p2, Lcn/jpush/android/ad/b$a;->f:I
...
.method private b(Landroid/content/Context;Lcn/jpush/android/ad/b$a;)Z
    .locals 11
    ...
    :cond_0
    iget v2, p2, Lcn/jpush/android/ad/b$a;->a:I

    const/4 v3, 0x1

    if-ne v2, v3, :cond_1

    iget-object v5, p2, Lcn/jpush/android/ad/b$a;->d:Ljava/util/ArrayList;

    iget-wide v6, p2, Lcn/jpush/android/ad/b$a;->c:J

    iget v8, p2, Lcn/jpush/android/ad/b$a;->b:I

    iget v9, p2, Lcn/jpush/android/ad/b$a;->f:I

    iget v10, p2, Lcn/jpush/android/ad/b$a;->g:I

    move-object v4, p1

    invoke-static/range {v4 .. v10}, Lcn/jpush/android/ad/a;->a(Landroid/content/Context;Ljava/util/List;JIII)Ljava/lang/String;
    ...
    iget-object v4, p2, Lcn/jpush/android/ad/b$a;->e:Ljava/lang/String;

    iget-wide v5, p2, Lcn/jpush/android/ad/b$a;->c:J

    invoke-static {p1, v4, v5, v6, v2}, Lcn/jpush/android/ad/a;->a(Landroid/content/Context;Ljava/lang/String;JI)Ljava/lang/String;
    ...
    iget v0, p2, Lcn/jpush/android/ad/b$a;->h:I

    const/16 v4, 0xc8

    if-le v0, v4, :cond_2

    iget-object v0, p0, Lcn/jpush/android/ad/b;->c:Ljava/util/concurrent/ConcurrentHashMap;

    iget-wide v4, p2, Lcn/jpush/android/ad/b$a;->c:J
    ...
    invoke-static {p1, v0, v2, v4, v5}, Lcn/jpush/android/ad/a;->a(Landroid/content/Context;IIJ)V
    ...
    invoke-static {p1, v0, v4, v5, v2}, Lcn/jpush/android/ad/a;->a(Landroid/content/Context;IJLjava/lang/String;)V

    iget p1, p2, Lcn/jpush/android/ad/b$a;->h:I

    add-int/2addr p1, v3

    iput p1, p2, Lcn/jpush/android/ad/b$a;->h:I

    iget-object p1, p0, Lcn/jpush/android/ad/b;->c:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public a(J)I
    ...
    check-cast p1, Lcn/jpush/android/ad/b$a;
    ...
    iget p1, p1, Lcn/jpush/android/ad/b$a;->a:I
...
.method public a(Landroid/content/Context;JILorg/json/JSONObject;Landroid/content/Intent;)Landroid/content/Intent;
    ...
    check-cast v0, Lcn/jpush/android/ad/b$a;
    ...
    iget-object v2, p0, Lcn/jpush/android/ad/b;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_1
    invoke-direct {p0, p1, p4, v0}, Lcn/jpush/android/ad/b;->a(Landroid/content/Context;ILcn/jpush/android/ad/b$a;)Z
    ...
    :cond_3
    iget p1, v0, Lcn/jpush/android/ad/b$a;->a:I

    invoke-virtual {p0, p1, p4}, Lcn/jpush/android/ad/b;->a(II)I
    ...
    iput p2, v0, Lcn/jpush/android/ad/b$a;->h:I

    iget p4, v0, Lcn/jpush/android/ad/b$a;->b:I
    ...
    iput p4, v0, Lcn/jpush/android/ad/b$a;->f:I
    ...
    iput p4, v0, Lcn/jpush/android/ad/b$a;->g:I

    invoke-direct {p0, p5, v0}, Lcn/jpush/android/ad/b;->a(Lorg/json/JSONObject;Lcn/jpush/android/ad/b$a;)Lcn/jpush/android/ad/b$a;

    :cond_5
    invoke-direct {p0, p1, v0}, Lcn/jpush/android/ad/b;->a(Landroid/content/Context;Lcn/jpush/android/ad/b$a;)Z
    ...
    iget p4, v0, Lcn/jpush/android/ad/b$a;->g:I
    ...
    iget v4, v0, Lcn/jpush/android/ad/b$a;->g:I
    ...
    iget v4, v0, Lcn/jpush/android/ad/b$a;->f:I
    ...
    iget p4, v0, Lcn/jpush/android/ad/b$a;->a:I

    iget-wide v4, v0, Lcn/jpush/android/ad/b$a;->c:J

    invoke-virtual {p0, p1, p4, v4, v5}, Lcn/jpush/android/ad/b;->a(Landroid/content/Context;IJ)Z
    ...
    :cond_6
    invoke-direct {p0, p1, v0}, Lcn/jpush/android/ad/b;->b(Landroid/content/Context;Lcn/jpush/android/ad/b$a;)Z
    ...
    :cond_7
    iget p1, v0, Lcn/jpush/android/ad/b$a;->b:I
    ...
    iget-object p1, v0, Lcn/jpush/android/ad/b$a;->d:Ljava/util/ArrayList;
    ...
    iget-object p1, v0, Lcn/jpush/android/ad/b$a;->e:Ljava/lang/String;
...
.method public a(IIJLjava/util/ArrayList;Ljava/lang/String;)V
    ...
    new-instance v8, Lcn/jpush/android/ad/b$a;
    ...
    invoke-direct/range {v0 .. v7}, Lcn/jpush/android/ad/b$a;-><init>(Lcn/jpush/android/ad/b;IIJLjava/util/ArrayList;Ljava/lang/String;)V
...
.method public a(I)Z
    ...
    check-cast v1, Lcn/jpush/android/ad/b$a;

    if-eqz v1, :cond_0

    iget v1, v1, Lcn/jpush/android/ad/b$a;->a:I
...
.method public a(Landroid/content/Context;IJ)Z
    ...
    invoke-static {p1, p2, v1, p3, p4}, Lcn/jpush/android/ad/a;->a(Landroid/content/Context;IIJ)V
