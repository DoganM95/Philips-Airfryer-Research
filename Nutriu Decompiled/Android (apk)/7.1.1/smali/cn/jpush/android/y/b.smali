...
.super Lcn/jpush/android/y/e;


# static fields
.field private static final a:[Ljava/lang/String;

.field private static volatile b:Lcn/jpush/android/y/b;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcn/jpush/android/y/b;->a:[Ljava/lang/String;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcn/jpush/android/y/b;->c:Ljava/lang/Object;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1, v2}, Lcn/jpush/android/y/e;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;I)V

    return-void
.end method

.method public static a(Landroid/content/Context;)Lcn/jpush/android/y/b;
    .locals 2

    sget-object v0, Lcn/jpush/android/y/b;->b:Lcn/jpush/android/y/b;

    if-nez v0, :cond_1

    sget-object v0, Lcn/jpush/android/y/b;->c:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcn/jpush/android/y/b;->b:Lcn/jpush/android/y/b;
    ...
    invoke-direct {v1, p0}, Lcn/jpush/android/y/b;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcn/jpush/android/y/b;->b:Lcn/jpush/android/y/b;
    ...
    :cond_1
    :goto_0
    sget-object p0, Lcn/jpush/android/y/b;->b:Lcn/jpush/android/y/b;

    return-object p0
.end method

.method public static a(Landroid/database/Cursor;)Lcn/jpush/android/y/c;
    .locals 5
    ...
    :cond_0
    :try_start_0
    new-instance v2, Lcn/jpush/android/y/c;

    invoke-direct {v2}, Lcn/jpush/android/y/c;-><init>()V
    ...
    invoke-virtual {v2, v3, v4}, Lcn/jpush/android/y/c;->a(J)V
    ...
    invoke-virtual {v2, v3}, Lcn/jpush/android/y/c;->a(I)V
    ...
    invoke-virtual {v2, v3}, Lcn/jpush/android/y/c;->b(I)V
    ...
    invoke-virtual {v2, v3}, Lcn/jpush/android/y/c;->c(I)V
    ...
    invoke-virtual {v2, v3}, Lcn/jpush/android/y/c;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v4}, Lcn/jpush/android/y/c;->c(J)V
    ...
    invoke-virtual {v2, v3, v4}, Lcn/jpush/android/y/c;->b(J)V

    invoke-virtual {v2}, Lcn/jpush/android/y/c;->toString()Ljava/lang/String;
...
.method public a(J)I
    ...
    invoke-virtual {p0, v0}, Lcn/jpush/android/y/e;->a(Z)Z
    ...
    invoke-virtual {p0, v0}, Lcn/jpush/android/y/e;->b(Z)V
...
.method public a(IJ)Landroid/database/Cursor;
    ...
    sget-object v4, Lcn/jpush/android/y/b;->a:[Ljava/lang/String;
...
.method public a(JI)Lcn/jpush/android/y/c;
    .locals 14
    ...
    invoke-virtual {p0, v2}, Lcn/jpush/android/y/e;->a(Z)Z
    ...
    sget-object v7, Lcn/jpush/android/y/b;->a:[Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v3}, Lcn/jpush/android/y/b;->a(Landroid/database/Cursor;)Lcn/jpush/android/y/c;
    ...
    :cond_1
    invoke-virtual {p0, v2}, Lcn/jpush/android/y/e;->b(Z)V
...
.method public a()[I
    ...
    invoke-virtual {p0, v10}, Lcn/jpush/android/y/e;->a(Z)Z
    ...
    :goto_0
    :try_start_3
    invoke-virtual {p0, v12}, Lcn/jpush/android/y/e;->a(Z)Z
    ...
    :cond_3
    invoke-virtual {p0, v10}, Lcn/jpush/android/y/e;->b(Z)V

    if-eqz v1, :cond_8

    invoke-virtual {p0, v12}, Lcn/jpush/android/y/e;->b(Z)V
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    invoke-virtual {p0, p1}, Lcn/jpush/android/y/b;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
