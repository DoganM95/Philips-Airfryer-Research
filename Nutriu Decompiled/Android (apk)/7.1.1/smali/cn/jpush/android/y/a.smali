...
# static fields
.field private static volatile a:Lcn/jpush/android/y/a;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcn/jpush/android/y/a;->e:Ljava/lang/Object;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcn/jpush/android/y/a;->b:Landroid/os/Handler;

    iput-object v0, p0, Lcn/jpush/android/y/a;->c:Landroid/content/Context;

    const-string v0, ""

    iput-object v0, p0, Lcn/jpush/android/y/a;->d:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcn/jpush/android/y/a;->c:Landroid/content/Context;

    invoke-virtual {p1}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lcn/jpush/android/y/a;->d:Ljava/lang/String;

    return-void
.end method

.method public static synthetic a(Lcn/jpush/android/y/a;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lcn/jpush/android/y/a;->c:Landroid/content/Context;

    return-object p0
.end method

.method public static a(Landroid/content/Context;)Lcn/jpush/android/y/a;
    .locals 2
    ...
    sget-object v0, Lcn/jpush/android/y/a;->a:Lcn/jpush/android/y/a;

    if-nez v0, :cond_1

    sget-object v0, Lcn/jpush/android/y/a;->e:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcn/jpush/android/y/a;->a:Lcn/jpush/android/y/a;

    if-nez v1, :cond_0

    new-instance v1, Lcn/jpush/android/y/a;

    invoke-direct {v1, p0}, Lcn/jpush/android/y/a;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcn/jpush/android/y/a;->a:Lcn/jpush/android/y/a;
    ...
    :cond_1
    :goto_0
    sget-object p0, Lcn/jpush/android/y/a;->a:Lcn/jpush/android/y/a;
...
.method private declared-synchronized a(JJI)V
    ...
    iget-object p5, p0, Lcn/jpush/android/y/a;->b:Landroid/os/Handler;

    if-eqz p5, :cond_1

    new-instance p5, Lcn/jpush/android/y/a$2;

    invoke-direct {p5, p0, p1, p2}, Lcn/jpush/android/y/a$2;-><init>(Lcn/jpush/android/y/a;J)V
    ...
    iget-object p1, p0, Lcn/jpush/android/y/a;->b:Landroid/os/Handler;
...
.method public static synthetic a(Lcn/jpush/android/y/a;Landroid/content/Context;)V
    .locals 0

    invoke-direct {p0, p1}, Lcn/jpush/android/y/a;->e(Landroid/content/Context;)V
...
.method private declared-synchronized e(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Lcn/jpush/android/y/b;->a(Landroid/content/Context;)Lcn/jpush/android/y/b;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lcn/jpush/android/y/e;->a(Z)Z
    ...
    invoke-virtual {v0, v5, v3, v4}, Lcn/jpush/android/y/b;->a(IJ)Landroid/database/Cursor;
    ...
    :cond_0
    invoke-static {v13}, Lcn/jpush/android/y/b;->a(Landroid/database/Cursor;)Lcn/jpush/android/y/c;

    move-result-object v2

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Lcn/jpush/android/y/c;->d()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p0, p1, v3}, Lcn/jpush/android/y/a;->a(Landroid/content/Context;Ljava/lang/String;)V

    invoke-virtual {v2}, Lcn/jpush/android/y/c;->a()J
    ...
    invoke-virtual {v2}, Lcn/jpush/android/y/c;->f()J

    move-result-wide v9

    invoke-virtual {v2}, Lcn/jpush/android/y/c;->e()J
    ...
    :cond_3
    :goto_0
    invoke-virtual {v0, v1}, Lcn/jpush/android/y/e;->b(Z)V
    :try_end_3
...
.method public declared-synchronized a(Landroid/content/Context;J)Z
    ...
    invoke-virtual {p1, p2, p3, v0}, Lcn/jpush/android/y/b;->a(JI)Lcn/jpush/android/y/c;
    ...
    invoke-virtual {p1, p2, p3}, Lcn/jpush/android/y/b;->a(J)I

    iget-object p1, p0, Lcn/jpush/android/y/a;->c:Landroid/content/Context;
...
.method public declared-synchronized a(Landroid/content/Context;Lcn/jpush/android/data/JPushLocalNotification;)Z
    ...
    invoke-virtual {v2, v3, v4, p1}, Lcn/jpush/android/y/b;->a(JI)Lcn/jpush/android/y/c;
    ...
    invoke-virtual/range {v2 .. v12}, Lcn/jpush/android/y/b;->a(JIIILjava/lang/String;JJ)J
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-direct/range {v2 .. v7}, Lcn/jpush/android/y/a;->a(JJI)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public declared-synchronized b(Landroid/content/Context;)V
    ...
    invoke-virtual {p1}, Lcn/jpush/android/y/b;->a()[I
    ...
    iget-object v3, p0, Lcn/jpush/android/y/a;->c:Landroid/content/Context;
...
.method public declared-synchronized c(Landroid/content/Context;)V
    ...
    invoke-virtual {p1, v0}, Lcn/jpush/android/y/e;->a(Z)Z
    ...
    invoke-virtual {p1, v2, v3, v4, v5}, Lcn/jpush/android/y/b;->a(JJ)Landroid/database/Cursor;
    ...
    :cond_0
    invoke-static {v1}, Lcn/jpush/android/y/b;->a(Landroid/database/Cursor;)Lcn/jpush/android/y/c;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-virtual {v4}, Lcn/jpush/android/y/c;->a()J

    move-result-wide v6

    invoke-virtual {v4}, Lcn/jpush/android/y/c;->f()J
    ...
    invoke-direct/range {v5 .. v10}, Lcn/jpush/android/y/a;->a(JJI)V
    ...
    :cond_3
    :goto_0
    invoke-virtual {p1, v0}, Lcn/jpush/android/y/e;->b(Z)V
    :try_end_2
...
.method public d(Landroid/content/Context;)V
    ...
    new-instance v1, Lcn/jpush/android/y/a$1;

    const-string v2, "JPushLocationNotificationCenter#onHeartBeat"

    invoke-direct {v1, p0, v2, p1}, Lcn/jpush/android/y/a$1;-><init>(Lcn/jpush/android/y/a;Ljava/lang/String;Landroid/content/Context;)V

    invoke-static {p1, v0, v1}, Lcn/jpush/android/helper/JCoreHelper;->futureExecutor(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Runnable;)V
