...
# virtual methods
.method public buildContentView(Ljava/lang/String;Ljava/lang/String;)Landroid/widget/RemoteViews;
    .locals 0
...
.method public buildNotification(Ljava/util/Map;)Landroid/app/Notification;
    ...
    invoke-static {v2, v6}, Lcn/jpush/android/aa/c;->b(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Object;
    ...
    instance-of v3, v2, Landroid/graphics/drawable/Icon;

    if-eqz v3, :cond_10

    check-cast v2, Landroid/graphics/drawable/Icon;

    invoke-virtual {v12, v2}, Landroid/app/Notification$Builder;->setLargeIcon(Landroid/graphics/drawable/Icon;)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v12, v3}, Landroid/app/Notification$Builder;->setShowWhen(Z)Landroid/app/Notification$Builder;

    :cond_12
    iget-object v2, v1, Lcn/jpush/android/api/DefaultPushNotificationBuilder;->context:Landroid/content/Context;

    iget-object v5, v1, Lcn/jpush/android/api/DefaultPushNotificationBuilder;->notificationMessage:Lcn/jpush/android/api/NotificationMessage;

    if-eqz v5, :cond_13

    iget-object v7, v5, Lcn/jpush/android/api/NotificationMessage;->notificationChannelId:Ljava/lang/String;
    ...
    invoke-static/range {v13 .. v19}, Lcn/jpush/android/aa/a;->a(Landroid/content/Context;Landroid/app/Notification$Builder;Ljava/lang/String;Ljava/lang/CharSequence;IILjava/lang/String;)V
    ...
    invoke-virtual {v12, v6}, Landroid/app/Notification$Builder;->setCustomBigContentView(Landroid/widget/RemoteViews;)Landroid/app/Notification$Builder;
    ...
    invoke-static {v4}, Lcn/jpush/android/aa/h;->a(Landroid/content/Context;)I
    ...
    invoke-static {v0, v3, v2, v5, v4}, Lcn/jpush/android/aa/c;->a(Landroid/app/Notification;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;)V
...
.method public getNotification(Landroid/app/Notification$Builder;)Landroid/app/Notification;
    .locals 2
...
.method public resetNotificationParams(Landroid/app/Notification;)V
    .locals 0
