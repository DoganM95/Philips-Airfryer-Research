...
.field public static final ACTION_IN_APP_MSG_RECEIVED:Ljava/lang/String; = "cn.jpush.android.intent.IN_APP_MSG_RECEIVED"
...
.method public static addLocalNotification(Landroid/content/Context;Lcn/jpush/android/data/JPushLocalNotification;)V
    ...
    invoke-static {p0, p1}, Lcn/jpush/android/y/d;->a(Landroid/content/Context;Lcn/jpush/android/data/JPushLocalNotification;)V
...
.method public static clearLocalNotifications(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcn/jpush/android/y/d;->a(Landroid/content/Context;)V
...
.method public static filterValidTags(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-static {p0}, Lcn/jpush/android/ad/a;->a(Ljava/util/Set;)Ljava/util/Set;
...
.method public static getStringTags(Ljava/util/Set;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcn/jpush/android/ad/a;->b(Ljava/util/Set;)Ljava/lang/String;
...
.method public static goToAppNotificationSettings(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcn/jpush/android/aa/c;->e(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lcn/jpush/android/aa/c;->f(Landroid/content/Context;)Z
...
.method public static init(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcn/jpush/android/af/a;->h(Landroid/content/Context;)Z
...
.method public static onFragmentPause(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string v1, "sync_fragment_life"
...
.method public static removeLocalNotification(Landroid/content/Context;J)V
    ...
    invoke-static {p0, p1, p2}, Lcn/jpush/android/y/d;->a(Landroid/content/Context;J)V
...
.method public static setLbsEnable(Landroid/content/Context;Z)V
    ...
    :try_start_1
    invoke-static {p0, v0}, Lcn/jpush/android/cache/a;->d(Landroid/content/Context;Z)V
...
.method public static triggerInAppMsgByEvent(Landroid/content/Context;ILjava/lang/String;)V
    ...
    const-string p2, "trigger_in_app_event"
