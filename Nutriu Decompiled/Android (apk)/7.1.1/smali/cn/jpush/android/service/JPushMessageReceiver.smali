...
.method public isNeedShowInAppMessage(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;Ljava/lang/String;)Z
    .locals 0
...
.method public onCheckInAppMessageState(Landroid/content/Context;Ljava/lang/String;)B
    .locals 0
...
.method public onCheckSspNotificationState(Landroid/content/Context;Ljava/lang/String;)B
    .locals 0
...
.method public onInAppMessageArrived(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcn/jpush/android/local/ActionHelper;->onInAppMessageArrived(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;)V
...
.method public onInAppMessageClick(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcn/jpush/android/local/ActionHelper;->onInAppMessageClick(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;)V

    return-void
.end method

.method public onInAppMessageDismiss(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;)V
    .locals 0

    return-void
.end method

.method public onInAppMessageUnShow(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;)V
    .locals 0
...
.method public onPullInAppResult(Landroid/content/Context;Lcn/jpush/android/api/JPushMessage;)V
    .locals 0
...
.method public onSspNotificationWillShow(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;Ljava/lang/String;)Z
    .locals 0
