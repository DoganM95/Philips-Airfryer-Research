.class public Lcn/jpush/android/w/d;
...
.method public static a(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    const-string v0, "inmsg_queue_v405"

    invoke-static {p0, v0}, Lcn/jpush/android/w/d;->b(Landroid/content/Context;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {p0, v0}, Lcn/jpush/android/w/d;->a(Landroid/content/Context;Ljava/lang/String;)V
...
.method private static declared-synchronized a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-class v0, Lcn/jpush/android/w/d;
    ...
    :try_start_0
    const-string p0, "InAppMsgQueueUtils"
...
.method private static declared-synchronized a(Landroid/content/Context;Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    :try_start_0
    const-string v1, "InAppMsgQueueUtils"
    ...
    :try_start_3
    const-string p1, "InAppMsgQueueUtils"
...
.method public static a(Landroid/content/Context;Lcn/jpush/android/d/a;Z)Z
    .locals 5

    sget-object v0, Lcn/jpush/android/w/d;->a:Ljava/util/Queue;

    const-string v1, "inmsg_queue_v405"

    const-string v2, "InAppMsgQueueUtils"
    ...
    sput-object v0, Lcn/jpush/android/w/d;->a:Ljava/util/Queue;

    :try_start_0
    invoke-static {p0, v1}, Lcn/jpush/android/w/d;->b(Landroid/content/Context;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    sget-object v4, Lcn/jpush/android/w/d;->a:Ljava/util/Queue;
    ...
    const-string v4, "init exposeMsgQueue failed:"
    ...
    const-string v3, "msg save in sp failed:"
    ...
    sget-object p2, Lcn/jpush/android/w/d;->a:Ljava/util/Queue;
    ...
    invoke-static {p0, v1, p2}, Lcn/jpush/android/w/d;->a(Landroid/content/Context;Ljava/lang/String;Ljava/util/ArrayList;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    const-string p2, "Exposed msg. remove processing - "
...
.method private static declared-synchronized b(Landroid/content/Context;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    :goto_2
    :try_start_5
    const-string v3, "InAppMsgQueueUtils"
    ...
    invoke-static {p0, p1}, Lcn/jpush/android/w/d;->a(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_5
