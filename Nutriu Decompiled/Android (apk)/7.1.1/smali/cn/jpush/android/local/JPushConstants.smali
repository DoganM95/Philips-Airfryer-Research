...
# static fields
.field public static BUILD_ID:I = 0x2
...
.field public static SDK_VERSION_CODE:I = 0x1a6

.field public static SDK_VERSION_NAME:Ljava/lang/String; = "4.2.2"
...
.method public static canGetLbsInBackGround(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v4}, Lcn/jpush/android/af/a;->b(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static getMessageReceiverClass(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0, v3, v4}, Lcn/jpush/android/af/a;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Class;)Landroid/content/pm/ComponentInfo;
...
.method private static initPageLifecycle(Landroid/content/Context;)V
    ...
    invoke-virtual {v5, v1}, Landroid/app/Application;->registerActivityLifecycleCallbacks(Landroid/app/Application$ActivityLifecycleCallbacks;)V

    sget v5, Lcn/jpush/android/local/ActivityLifeCallBack;->activityTaskCount:I
    ...
    invoke-virtual {v1, p0, v4}, Lcn/jpush/android/local/ActivityLifeCallBack;->onActivityCreated(Landroid/app/Activity;Landroid/os/Bundle;)V

    invoke-virtual {v1, p0}, Lcn/jpush/android/local/ActivityLifeCallBack;->onActivityStarted(Landroid/app/Activity;)V

    invoke-virtual {v1, p0}, Lcn/jpush/android/local/ActivityLifeCallBack;->onActivityResumed(Landroid/app/Activity;)V
    ...
    const-string v1, "initPageLifecycle in main process, packageName:"
    ...
    const-string v5, "need not initPageLifecycle in other process :"
    ...
    iput v1, v2, Lcn/jpush/android/d/d;->q:I

    const-string v1, "sync_reg_lifecycle"

    invoke-static {p0, v1, v2, v4}, Lcn/jpush/android/aa/c;->a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;Landroid/content/Intent;)V
    :try_end_0
...
.method public static isSameProcessWithJCommonService(Landroid/content/Context;)Z
    ...
    :try_start_0
    sget-object v1, Lcn/jpush/android/local/JPushConstants;->isSameProcessWithJCommonService:Ljava/lang/Boolean;
    ...
    invoke-static {p0, v1, v2}, Lcn/jpush/android/af/a;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Class;)Landroid/content/pm/ComponentInfo;
