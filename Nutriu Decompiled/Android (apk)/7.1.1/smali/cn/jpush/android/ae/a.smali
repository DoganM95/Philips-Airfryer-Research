.class public Lcn/jpush/android/ae/a;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcn/jpush/android/ae/a$a;
    }
.end annotation


# static fields
.field private static volatile b:Lcn/jpush/android/ae/a;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcn/jpush/android/ae/a;->a:Ljava/util/Map;

    return-void
.end method

.method private a(J)Lcn/jpush/android/ae/a$a;
    .locals 4

    iget-object v0, p0, Lcn/jpush/android/ae/a;->a:Ljava/util/Map;
    ...
    check-cast v2, Lcn/jpush/android/ae/a$a;

    iget-wide v2, v2, Lcn/jpush/android/ae/a$a;->c:J
    ...
    check-cast p1, Lcn/jpush/android/ae/a$a;
...
.method public static a()Lcn/jpush/android/ae/a;
    .locals 2

    sget-object v0, Lcn/jpush/android/ae/a;->b:Lcn/jpush/android/ae/a;

    if-nez v0, :cond_1

    const-class v0, Lcn/jpush/android/ae/a;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcn/jpush/android/ae/a;->b:Lcn/jpush/android/ae/a;

    if-nez v1, :cond_0

    new-instance v1, Lcn/jpush/android/ae/a;

    invoke-direct {v1}, Lcn/jpush/android/ae/a;-><init>()V

    sput-object v1, Lcn/jpush/android/ae/a;->b:Lcn/jpush/android/ae/a;
...
.method private declared-synchronized a(Landroid/content/Context;Lcn/jpush/android/ae/a$a;)V
    .locals 9
    ...
    iget-wide v4, p2, Lcn/jpush/android/ae/a$a;->c:J

    const-wide/16 v6, 0x2710

    iget-object v8, p2, Lcn/jpush/android/ae/a$a;->d:[B
...
.method private b(Landroid/content/Context;BLjava/lang/String;)V
    ...
    invoke-static {p3, p2}, Lcn/jpush/android/ac/c;->a(Ljava/lang/String;B)[B

    move-result-object v6

    new-instance v7, Lcn/jpush/android/ae/a$a;
    ...
    invoke-direct/range {v0 .. v6}, Lcn/jpush/android/ae/a$a;-><init>(Lcn/jpush/android/ae/a;BLjava/lang/String;J[B)V

    iget-object p3, p0, Lcn/jpush/android/ae/a;->a:Ljava/util/Map;
    ...
    invoke-direct {p0, p1, v7}, Lcn/jpush/android/ae/a;->a(Landroid/content/Context;Lcn/jpush/android/ae/a$a;)V
...
.method public declared-synchronized a(Landroid/content/Context;BLjava/lang/String;)V
    ...
    check-cast v0, Lcn/jpush/android/ae/a$a;

    iget-object v0, v0, Lcn/jpush/android/ae/a$a;->b:Ljava/lang/String;
    ...
    :cond_1
    :try_start_2
    invoke-direct {p0, p1, p2, p3}, Lcn/jpush/android/ae/a;->b(Landroid/content/Context;BLjava/lang/String;)V
...
.method public a(Landroid/content/Context;J)V
    ...
    invoke-direct {p0, p2, p3}, Lcn/jpush/android/ae/a;->a(J)Lcn/jpush/android/ae/a$a;
    ...
    iget-byte v1, v0, Lcn/jpush/android/ae/a$a;->a:B

    invoke-static {v1}, Lcn/jpush/android/cache/Key;->ThirdPush_RegID(B)Lcn/jpush/android/cache/Key;

    move-result-object v1

    iget-object v2, v0, Lcn/jpush/android/ae/a$a;->b:Ljava/lang/String;
    ...
    iget-byte p3, v0, Lcn/jpush/android/ae/a$a;->a:B
    ...
    iget-object p2, p0, Lcn/jpush/android/ae/a;->a:Ljava/util/Map;
    ...
    invoke-virtual {p2, p1, p3, v0}, Lcn/jpush/android/ae/c;->a(Landroid/content/Context;ILjava/lang/String;)V
...
.method public a(Landroid/content/Context;JI)V
    ...
    iget p2, v0, Lcn/jpush/android/ae/a$a;->e:I
    ...
    iput p2, v0, Lcn/jpush/android/ae/a$a;->e:I

    invoke-direct {p0, p1, v0}, Lcn/jpush/android/ae/a;->a(Landroid/content/Context;Lcn/jpush/android/ae/a$a;)V
    ...
    iget-object p1, p0, Lcn/jpush/android/ae/a;->a:Ljava/util/Map;

    iget-byte p2, v0, Lcn/jpush/android/ae/a$a;->a:B
