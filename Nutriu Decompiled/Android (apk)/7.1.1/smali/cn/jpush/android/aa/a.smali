...
.method private static a(Landroid/content/Context;II)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcn/jpush/android/aa/a;->a(I)I
    ...
    invoke-static {p0, p1}, Lcn/jpush/android/aa/a;->a(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v5}, Lcn/jpush/android/aa/a;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/CharSequence;IILandroid/net/Uri;)Z
...
.method private static a(Lcn/jpush/android/aa/a$a;)Ljava/lang/String;
    .locals 3
    ...
    iget v1, p0, Lcn/jpush/android/aa/a$a;->d:I
    ...
    iget v2, p0, Lcn/jpush/android/aa/a$a;->e:I
    ...
    iget-object v2, p0, Lcn/jpush/android/aa/a$a;->g:Landroid/net/Uri;
    ...
    iget-object p0, p0, Lcn/jpush/android/aa/a$a;->f:Ljava/lang/String;
...
.method public static a(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0, v1}, Lcn/jpush/android/aa/a;->a(Landroid/content/Context;II)Ljava/lang/String;

    const/4 v0, 0x7

    invoke-static {p0, v1, v0}, Lcn/jpush/android/aa/a;->a(Landroid/content/Context;II)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Landroid/app/Notification$Builder;Ljava/lang/String;Ljava/lang/CharSequence;IILjava/lang/String;)V
    ...
    invoke-static {p0, p1, v6}, Lcn/jpush/android/aa/c;->a(Landroid/content/Context;Landroid/app/Notification$Builder;Lcn/jpush/android/aa/a$a;)V
...
.method public static a(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/String;Ljava/lang/CharSequence;IILjava/lang/String;)V
    ...
    invoke-static {p1, v6}, Lcn/jpush/android/aa/c;->a(Landroid/app/Notification;Lcn/jpush/android/aa/a$a;)V

    return-void
.end method

.method public static a(Landroid/content/Context;Lcn/jpush/android/aa/a$a;)V
    .locals 9

    invoke-static {p0}, Lcn/jpush/android/aa/c;->c(Landroid/content/Context;)Z
    ...
    iput-object v0, p1, Lcn/jpush/android/aa/a$a;->a:Ljava/lang/String;

    iput v1, p1, Lcn/jpush/android/aa/a$a;->e:I

    iput-object v5, p1, Lcn/jpush/android/aa/a$a;->f:Ljava/lang/String;
    ...
    iget-object v0, p1, Lcn/jpush/android/aa/a$a;->a:Ljava/lang/String;

    invoke-static {p0, v0}, Lcn/jpush/android/aa/a;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    iput-object p0, p1, Lcn/jpush/android/aa/a$a;->a:Ljava/lang/String;

    invoke-virtual {v0}, Landroid/app/NotificationChannel;->getName()Ljava/lang/CharSequence;

    move-result-object p0

    iput-object p0, p1, Lcn/jpush/android/aa/a$a;->b:Ljava/lang/CharSequence;

    invoke-virtual {v0}, Landroid/app/NotificationChannel;->getImportance()I

    move-result p0

    iput p0, p1, Lcn/jpush/android/aa/a$a;->d:I

    invoke-static {p0}, Lcn/jpush/android/aa/a;->b(I)I

    move-result p0

    iput p0, p1, Lcn/jpush/android/aa/a$a;->c:I

    invoke-virtual {v0}, Landroid/app/NotificationChannel;->getSound()Landroid/net/Uri;

    move-result-object p0

    iput-object p0, p1, Lcn/jpush/android/aa/a$a;->g:Landroid/net/Uri;
    ...
    iput-object p0, p1, Lcn/jpush/android/aa/a$a;->f:Ljava/lang/String;

    :cond_1
    iput-boolean v4, p1, Lcn/jpush/android/aa/a$a;->h:Z

    return-void

    :cond_2
    :goto_0
    iget v0, p1, Lcn/jpush/android/aa/a$a;->c:I
    ...
    iget-object v0, p1, Lcn/jpush/android/aa/a$a;->f:Ljava/lang/String;
    ...
    iput v7, p1, Lcn/jpush/android/aa/a$a;->c:I
    ...
    iput v0, p1, Lcn/jpush/android/aa/a$a;->e:I
    ...
    iput v4, p1, Lcn/jpush/android/aa/a$a;->c:I

    :cond_6
    iget v0, p1, Lcn/jpush/android/aa/a$a;->c:I

    invoke-static {v0}, Lcn/jpush/android/aa/a;->a(I)I

    move-result v0

    iput v0, p1, Lcn/jpush/android/aa/a$a;->d:I

    invoke-static {v0}, Lcn/jpush/android/aa/a;->b(I)I

    move-result v0

    iput v0, p1, Lcn/jpush/android/aa/a$a;->c:I

    iget-object v0, p1, Lcn/jpush/android/aa/a$a;->f:Ljava/lang/String;

    invoke-static {p0, v0}, Lcn/jpush/android/aa/c;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p1, Lcn/jpush/android/aa/a$a;->g:Landroid/net/Uri;
    ...
    invoke-static {p1}, Lcn/jpush/android/aa/a;->a(Lcn/jpush/android/aa/a$a;)Ljava/lang/String;
    ...
    :cond_8
    iget-object v0, p1, Lcn/jpush/android/aa/a$a;->b:Ljava/lang/CharSequence;
    ...
    const-string v1, "KG_channel_normal"
    ...
    invoke-static {p0, v0}, Lcn/jpush/android/aa/a;->a(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    :goto_4
    iput-object v0, p1, Lcn/jpush/android/aa/a$a;->b:Ljava/lang/CharSequence;
    ...
    iget-object v1, p1, Lcn/jpush/android/aa/a$a;->a:Ljava/lang/String;
    ...
    iget-object v1, p1, Lcn/jpush/android/aa/a$a;->b:Ljava/lang/CharSequence;
    ...
    iget-object v1, p1, Lcn/jpush/android/aa/a$a;->g:Landroid/net/Uri;
    ...
    iget-object v4, p1, Lcn/jpush/android/aa/a$a;->a:Ljava/lang/String;

    iget-object v5, p1, Lcn/jpush/android/aa/a$a;->b:Ljava/lang/CharSequence;

    iget v6, p1, Lcn/jpush/android/aa/a$a;->d:I

    iget v7, p1, Lcn/jpush/android/aa/a$a;->e:I

    iget-object v8, p1, Lcn/jpush/android/aa/a$a;->g:Landroid/net/Uri;

    move-object v3, p0

    invoke-static/range {v3 .. v8}, Lcn/jpush/android/aa/a;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/CharSequence;IILandroid/net/Uri;)Z

    move-result p0

    iput-boolean p0, p1, Lcn/jpush/android/aa/a$a;->h:Z
...
.method private static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/CharSequence;IILandroid/net/Uri;)Z
    ...
    invoke-static {p0}, Lcn/jpush/android/af/a;->b(Landroid/content/Context;)Ljava/lang/String;
