...
.method public constructor <init>(II)V
    ...
    iput p1, p0, Lcn/jiguang/ba/b;->g:I
    ...
    iput-object p1, p0, Lcn/jiguang/ba/b;->h:Ljava/nio/ByteBuffer;

    iput p2, p0, Lcn/jiguang/ba/a;->f:I
...
.method private b([B)Z
    ...
    :try_start_0
    invoke-virtual {p0}, Lcn/jiguang/ba/a;->b()Z
    ...
    :cond_1
    iget-object v2, p0, Lcn/jiguang/ba/a;->b:Ljava/nio/channels/SocketChannel;
    ...
    invoke-static {v0, p1}, Lcn/jiguang/ar/c;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcn/jiguang/ba/b;->close()V
...
.method public declared-synchronized a(Ljava/lang/String;I)I
    ...
    :try_start_0
    invoke-super {p0, p1, p2}, Lcn/jiguang/ba/a;->a(Ljava/lang/String;I)I
    :try_end_0
    ...
    iput-object v1, p0, Lcn/jiguang/ba/a;->b:Ljava/nio/channels/SocketChannel;

    invoke-static {}, Ljava/nio/channels/Selector;->open()Ljava/nio/channels/Selector;

    move-result-object v1

    iput-object v1, p0, Lcn/jiguang/ba/a;->d:Ljava/nio/channels/Selector;

    iget-object v1, p0, Lcn/jiguang/ba/a;->b:Ljava/nio/channels/SocketChannel;
    ...
    iget-object p1, p0, Lcn/jiguang/ba/a;->b:Ljava/nio/channels/SocketChannel;
    ...
    invoke-static {p1, p2}, Lcn/jiguang/ar/c;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-boolean v1, p0, Lcn/jiguang/ba/a;->e:Z
    ...
    :cond_2
    :try_start_3
    iget-boolean p1, p0, Lcn/jiguang/ba/a;->e:Z
    ...
    iget-object p2, p0, Lcn/jiguang/ba/a;->d:Ljava/nio/channels/Selector;
    ...
    invoke-static {p2, v1}, Lcn/jiguang/ar/c;->h(Ljava/lang/String;Ljava/lang/String;)V
...
.method public a([B)I
    ...
    iget v3, p0, Lcn/jiguang/ba/b;->g:I
    ...
    iget v0, p0, Lcn/jiguang/ba/b;->g:I
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcn/jiguang/ba/b;->b([B)Z
...
.method public a(I)Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0}, Lcn/jiguang/ba/a;->c()I

    move-result v2

    if-lez v2, :cond_0

    invoke-virtual {p0, v2}, Lcn/jiguang/ba/a;->b(I)Ljava/nio/ByteBuffer;
    ...
    :try_start_1
    iget v5, p0, Lcn/jiguang/ba/a;->c:I

    if-ge v5, v4, :cond_9

    if-lez p1, :cond_2

    iget-object v5, p0, Lcn/jiguang/ba/a;->d:Ljava/nio/channels/Selector;
    ...
    invoke-static {v6, v5}, Lcn/jiguang/ar/c;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p1, v1, v2}, Lcn/jiguang/ax/f;-><init>(ILjava/lang/String;)V
    ...
    iget-object v3, p0, Lcn/jiguang/ba/b;->h:Ljava/nio/ByteBuffer;
    ...
    iget-object v8, p0, Lcn/jiguang/ba/b;->h:Ljava/nio/ByteBuffer;
    ...
    iget-object v9, p0, Lcn/jiguang/ba/a;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object v7, p0, Lcn/jiguang/ba/a;->a:Ljava/nio/ByteBuffer;

    iget-object v9, p0, Lcn/jiguang/ba/b;->h:Ljava/nio/ByteBuffer;

    invoke-virtual {v7, v9}, Ljava/nio/ByteBuffer;->put(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;

    iget v7, p0, Lcn/jiguang/ba/a;->c:I

    add-int/2addr v7, v8

    iput v7, p0, Lcn/jiguang/ba/a;->c:I

    iget-object v7, p0, Lcn/jiguang/ba/b;->h:Ljava/nio/ByteBuffer;

    invoke-virtual {v7}, Ljava/nio/ByteBuffer;->compact()Ljava/nio/ByteBuffer;

    iget v7, p0, Lcn/jiguang/ba/a;->c:I

    iget v9, p0, Lcn/jiguang/ba/a;->f:I
    ...
    iget v9, p0, Lcn/jiguang/ba/a;->c:I
    ...
    invoke-static {v6, v3}, Lcn/jiguang/ar/c;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcn/jiguang/ba/a;->a:Ljava/nio/ByteBuffer;
    ...
    invoke-direct {p1, v7, v2}, Lcn/jiguang/ax/f;-><init>(ILjava/lang/String;)V
    ...
    iget v0, p0, Lcn/jiguang/ba/a;->c:I
    ...
    invoke-static {v6, p1}, Lcn/jiguang/ar/c;->c(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v4}, Lcn/jiguang/ba/a;->b(I)Ljava/nio/ByteBuffer;
    ...
    invoke-direct {p1, v0, v1}, Lcn/jiguang/ax/f;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {p1, v2, v3}, Lcn/jiguang/ax/f;-><init>(ILjava/lang/String;)V
    ...
    instance-of v1, p1, Lcn/jiguang/ax/f;

    if-eqz v1, :cond_d

    check-cast p1, Lcn/jiguang/ax/f;
    ...
    invoke-direct {v1, v0, p1}, Lcn/jiguang/ax/f;-><init>(ILjava/lang/String;)V
...
.method public close()V
    ...
    invoke-super {p0}, Lcn/jiguang/ba/a;->close()V

    iget-object v0, p0, Lcn/jiguang/ba/a;->d:Ljava/nio/channels/Selector;
    ...
    :catch_0
    :cond_0
    iget-object v0, p0, Lcn/jiguang/ba/a;->b:Ljava/nio/channels/SocketChannel;

    invoke-static {v0}, Lcn/jiguang/f/i;->a(Ljava/io/Closeable;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lcn/jiguang/ba/a;->b:Ljava/nio/channels/SocketChannel;
