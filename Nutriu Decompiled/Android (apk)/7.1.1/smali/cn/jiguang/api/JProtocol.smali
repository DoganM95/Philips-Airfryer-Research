...
.field public head:Lcn/jiguang/bd/c;
...
.method public constructor <init>(ZIIJ)V
    ...
    new-instance v6, Lcn/jiguang/bd/c;
    ...
    invoke-direct/range {v0 .. v5}, Lcn/jiguang/bd/c;-><init>(ZIIJ)V

    iput-object v6, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bd/c;
...
.method public constructor <init>(ZIIJIJ)V
    ...
    new-instance v11, Lcn/jiguang/bd/c;
    ...
    invoke-direct/range {v1 .. v10}, Lcn/jiguang/bd/c;-><init>(ZIIIJIJ)V

    iput-object v11, v0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bd/c;
...
.method public constructor <init>(ZLjava/lang/Object;Ljava/nio/ByteBuffer;)V
    ...
    check-cast p2, Lcn/jiguang/bd/c;

    iput-object p2, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bd/c;
...
.method public constructor <init>(ZLjava/nio/ByteBuffer;[B)V
    ...
    invoke-direct {v1, p1, p3}, Lcn/jiguang/bd/c;-><init>(Z[B)V

    iput-object v1, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bd/c;
    :try_end_0
...
.method public static parseHead(Ljava/lang/Object;)[B
    ...
    :cond_0
    instance-of v2, p0, Lcn/jiguang/bd/c;

    if-eqz v2, :cond_1

    check-cast p0, Lcn/jiguang/bd/c;

    invoke-virtual {p0}, Lcn/jiguang/bd/c;->f()[B
...
.method private final toBytes()[B
    ...
    :cond_0
    iget-object v3, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bd/c;
    ...
    invoke-virtual {v3, v4}, Lcn/jiguang/bd/c;->a(I)V

    :try_start_0
    iget-object v3, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bd/c;

    invoke-virtual {v3}, Lcn/jiguang/bd/c;->f()[B
    ...
    invoke-static {v0}, Lcn/jiguang/bd/f;->a([B)Ljava/lang/String;
    ...
    invoke-static {v2, v1}, Lcn/jiguang/bd/d;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public getCommand()I
    ...
    iget-object v0, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bd/c;

    invoke-virtual {v0}, Lcn/jiguang/bd/c;->a()I
...
.method public getHead()Lcn/jiguang/bd/c;
    .locals 1
...
.method public getJuid()J
    ...
    invoke-virtual {v0}, Lcn/jiguang/bd/c;->c()J
...
.method public getRid()Ljava/lang/Long;
    ...
    invoke-virtual {v0}, Lcn/jiguang/bd/c;->b()Ljava/lang/Long;
...
.method public getSid()I
    ...
    invoke-virtual {v0}, Lcn/jiguang/bd/c;->d()I
...
.method public getVersion()I
    ...
    invoke-virtual {v0}, Lcn/jiguang/bd/c;->e()I
...
.method public abstract isNeedParseeErrorMsg()Z
.end method

.method public abstract parseBody()V
.end method
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bd/c;

    invoke-virtual {v1}, Lcn/jiguang/bd/c;->toString()Ljava/lang/String;
...
.method public abstract writeBody()V
.end method
...
.method public writeTlv2(Ljava/lang/String;)V
    .locals 1
