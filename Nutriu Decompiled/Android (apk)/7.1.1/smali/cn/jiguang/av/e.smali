...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lcn/jiguang/av/e$1;

    invoke-direct {v0}, Lcn/jiguang/av/e$1;-><init>()V

    sput-object v0, Lcn/jiguang/av/e;->a:Ljava/util/Comparator;
...
.method public static a(Landroid/content/Context;Ljava/util/LinkedHashSet;J)Ljava/util/LinkedHashSet;
    ...
    check-cast v4, Lcn/jiguang/av/g;

    invoke-virtual {v4}, Lcn/jiguang/av/g;->a()Z
    ...
    :cond_2
    invoke-virtual {v4}, Lcn/jiguang/av/g;->toString()Ljava/lang/String;
    ...
    invoke-static {v6}, Lcn/jiguang/av/d;->a(Ljava/lang/String;)Lcn/jiguang/av/d;

    move-result-object v6

    if-nez v6, :cond_3

    new-instance v6, Lcn/jiguang/av/d;

    invoke-direct {v6, v4}, Lcn/jiguang/av/d;-><init>(Lcn/jiguang/av/g;)V

    :cond_3
    if-eqz v3, :cond_4

    iput v2, v6, Lcn/jiguang/av/d;->e:I
    ...
    iput-wide p2, v6, Lcn/jiguang/av/d;->c:J

    new-array v4, v2, [Lcn/jiguang/g/a;

    invoke-virtual {v6}, Lcn/jiguang/av/d;->a()Ljava/lang/String;
    ...
    :cond_6
    sget-object p0, Lcn/jiguang/av/e;->a:Ljava/util/Comparator;

    invoke-static {v1, p0}, Lcn/jiguang/av/e;->a(Ljava/util/Collection;Ljava/util/Comparator;)Ljava/util/LinkedList;
    ...
    check-cast p3, Lcn/jiguang/av/d;

    iget-object p3, p3, Lcn/jiguang/av/d;->a:Lcn/jiguang/av/g;
...
.method public static a(Landroid/content/Context;Lcn/jiguang/av/g;IJ)V
    .locals 2

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lcn/jiguang/av/g;->toString()Ljava/lang/String;
    ...
    invoke-static {v1}, Lcn/jiguang/av/d;->a(Ljava/lang/String;)Lcn/jiguang/av/d;
    ...
    invoke-direct {v1, p1}, Lcn/jiguang/av/d;-><init>(Lcn/jiguang/av/g;)V

    :cond_0
    iput-wide p3, v1, Lcn/jiguang/av/d;->d:J

    iput p2, v1, Lcn/jiguang/av/d;->b:I
    ...
    invoke-virtual {v1}, Lcn/jiguang/av/d;->a()Ljava/lang/String;
