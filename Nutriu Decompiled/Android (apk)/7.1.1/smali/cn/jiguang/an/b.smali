...
.method public static a(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    :goto_1
    invoke-static {p0}, Lcn/jiguang/an/a;->b(Landroid/content/Context;)Ljava/lang/Object;
    ...
    new-instance v1, Lcn/jiguang/an/b$a;

    invoke-direct {v1, p0, p1}, Lcn/jiguang/an/b$a;-><init>(Landroid/content/Context;Lorg/json/JSONObject;)V
...
.method public static synthetic b(Landroid/content/Context;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1}, Lcn/jiguang/an/b;->c(Landroid/content/Context;Lorg/json/JSONObject;)V
...
.method private static c(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, v3}, Lcn/jiguang/n/b;->e(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v2, v7}, Lcn/jiguang/ak/a;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v8, Lcn/jiguang/ao/c;

    invoke-direct {v8}, Lcn/jiguang/ao/c;-><init>()V

    iput-object v6, v8, Lcn/jiguang/ao/c;->a:Ljava/lang/String;

    iput-object p1, v8, Lcn/jiguang/ao/c;->b:Ljava/lang/String;

    iget v7, v7, Landroid/content/pm/ApplicationInfo;->targetSdkVersion:I

    iput v7, v8, Lcn/jiguang/ao/c;->c:I

    iput v5, v8, Lcn/jiguang/ao/c;->i:I

    const/4 v5, 0x4

    iput v5, v8, Lcn/jiguang/ao/c;->g:I

    invoke-interface {v0, v8}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    :cond_0
    invoke-static {v3, v6, p1, v4}, Lcn/jiguang/ap/d;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Ljava/util/List;

    move-result-object p1

    invoke-static {p1}, Lcn/jiguang/ap/c;->a(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, p1}, Lcn/jiguang/r/c;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v3}, Lcn/jiguang/ap/c;->a(Ljava/lang/String;)Ljava/util/List;

    move-result-object p1

    invoke-static {p0, p1}, Lcn/jiguang/ap/c;->a(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p0, v0}, Lcn/jiguang/an/a;->a(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
