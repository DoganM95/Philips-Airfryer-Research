...
# static fields
.field public static EMPTY_IA_ARRAY:[Lm/d/u/e; = null

.field public static final MAX_DELAY_BETWEEN_STATUS_MESSAGES:I = 0x493e0000
...
.field public delayBetweenStatusMessages:I
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lch/qos/logback/core/net/SMTPAppenderBase;->EMPTY_IA_ARRAY:[Lm/d/u/e;
...
.method private buildSessionFromProperties()Lm/d/o;
    .locals 5
    ...
    :cond_5
    :goto_0
    invoke-static {v0, v1}, Lm/d/o;->g(Ljava/util/Properties;Lm/d/b;)Lm/d/o;
...
.method private parseAddress(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v3, v4}, Lm/d/u/e;->s(Ljava/lang/String;Z)[Lm/d/u/e;
...
.method public append(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v5, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->eventEvaluator:Lch/qos/logback/core/boolex/EventEvaluator;

    invoke-interface {v5, p1}, Lch/qos/logback/core/boolex/EventEvaluator;->evaluate(Ljava/lang/Object;)Z

    move-result v5

    if-eqz v5, :cond_2

    new-instance v5, Lch/qos/logback/core/helpers/CyclicBuffer;

    invoke-direct {v5, v3}, Lch/qos/logback/core/helpers/CyclicBuffer;-><init>(Lch/qos/logback/core/helpers/CyclicBuffer;)V
    ...
    invoke-direct {v3, p0, v5, p1}, Lch/qos/logback/core/net/SMTPAppenderBase$SenderRunnable;-><init>(Lch/qos/logback/core/net/SMTPAppenderBase;Lch/qos/logback/core/helpers/CyclicBuffer;Ljava/lang/Object;)V

    iget-object v5, p0, Lch/qos/logback/core/spi/ContextAwareBase;->context:Lch/qos/logback/core/Context;

    invoke-interface {v5}, Lch/qos/logback/core/Context;->getExecutorService()Ljava/util/concurrent/ExecutorService;
    ...
    :cond_1
    invoke-virtual {p0, v5, p1}, Lch/qos/logback/core/net/SMTPAppenderBase;->sendBuffer(Lch/qos/logback/core/helpers/CyclicBuffer;Ljava/lang/Object;)V
    :try_end_0
    ...
    invoke-virtual {p0, v5, v3}, Lch/qos/logback/core/spi/ContextAwareBase;->addError(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-wide v5, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->lastTrackerStatusPrint:J

    iget p1, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->delayBetweenStatusMessages:I
    ...
    const/high16 v0, 0x493e0000

    if-ge p1, v0, :cond_4

    mul-int/2addr p1, v4

    iput p1, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->delayBetweenStatusMessages:I
...
.method public checkEntryConditions()Z
    ...
    :cond_0
    iget-object v0, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->mimeMsg:Lm/d/u/i;

    if-nez v0, :cond_1

    const-string v0, "Message object not configured."
...
.method public getAddress(Ljava/lang/String;)Lm/d/u/e;
    .locals 3

    :try_start_0
    new-instance v0, Lm/d/u/e;

    invoke-direct {v0, p1}, Lm/d/u/e;-><init>(Ljava/lang/String;)V
    :try_end_0
    .catch Ljavax/mail/internet/AddressException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getMessage()Lm/d/i;
    .locals 1
...
.method public sendBuffer(Lch/qos/logback/core/helpers/CyclicBuffer;Ljava/lang/Object;)V
    ...
    invoke-direct {v0}, Lm/d/u/h;-><init>()V
    ...
    iget-object v2, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->subjectLayout:Lch/qos/logback/core/Layout;

    if-eqz v2, :cond_5

    invoke-interface {v2, p2}, Lch/qos/logback/core/Layout;->doLayout(Ljava/lang/Object;)Ljava/lang/String;
    ...
    :cond_5
    iget-object v2, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->mimeMsg:Lm/d/u/i;

    iget-object v3, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->charsetEncoding:Ljava/lang/String;

    invoke-virtual {v2, p1, v3}, Lm/d/u/i;->y(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    sget-object v2, Lch/qos/logback/core/net/SMTPAppenderBase;->EMPTY_IA_ARRAY:[Lm/d/u/e;

    invoke-interface {p2, v2}, Ljava/util/List;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;

    move-result-object p2

    check-cast p2, [Lm/d/u/e;

    iget-object v2, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->mimeMsg:Lm/d/u/i;

    sget-object v3, Lm/d/i$a;->a:Lm/d/i$a;

    invoke-virtual {v2, v3, p2}, Lm/d/u/i;->w(Lm/d/i$a;[Lm/d/a;)V
    ...
    invoke-virtual {v0, v1, v3, v2}, Lm/d/u/h;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v2}, Lm/d/u/h;->f(Ljava/lang/Object;Ljava/lang/String;)V

    :goto_1
    new-instance v1, Lm/d/u/j;

    invoke-direct {v1}, Lm/d/u/j;-><init>()V

    invoke-virtual {v1, v0}, Lm/d/j;->a(Lm/d/c;)V

    iget-object v0, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->mimeMsg:Lm/d/u/i;

    invoke-virtual {v0, v1}, Lm/d/u/i;->s(Lm/d/j;)V
    ...
    invoke-virtual {v0, v1}, Lm/d/u/i;->x(Ljava/util/Date;)V

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string v1, "About to send out SMTP message \""
    ...
    iget-object p1, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->mimeMsg:Lm/d/u/i;

    invoke-static {p1}, Lm/d/r;->A(Lm/d/i;)V
    :try_end_0
...
.method public setMessage(Lm/d/u/i;)V
    .locals 0

    iput-object p1, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->mimeMsg:Lm/d/u/i;
...
.method public start()V
    ...
    :cond_0
    invoke-direct {p0}, Lch/qos/logback/core/net/SMTPAppenderBase;->buildSessionFromProperties()Lm/d/o;
    ...
    :cond_1
    new-instance v1, Lm/d/u/i;

    invoke-direct {v1, v0}, Lm/d/u/i;-><init>(Lm/d/o;)V

    iput-object v1, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->mimeMsg:Lm/d/u/i;
    ...
    invoke-virtual {p0, v0}, Lch/qos/logback/core/net/SMTPAppenderBase;->getAddress(Ljava/lang/String;)Lm/d/u/e;

    move-result-object v0

    invoke-virtual {v1, v0}, Lm/d/u/i;->v(Lm/d/a;)V

    goto :goto_0

    :cond_2
    invoke-virtual {v1}, Lm/d/u/i;->u()V
