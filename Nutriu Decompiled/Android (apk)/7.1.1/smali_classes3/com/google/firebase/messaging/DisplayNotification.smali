...
.method private showNotification(Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;)V
    ...
    iget-object p1, p1, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;->notificationBuilder:Lb/i/e/i$e;

    .line 4
    invoke-virtual {p1}, Lb/i/e/i$e;->build()Landroid/app/Notification;
...
.method private waitForAndApplyImageDownload(Lb/i/e/i$e;Lcom/google/firebase/messaging/ImageDownload;)V
    .locals 5
    ...
    .line 2
    invoke-virtual {p1, v1}, Lb/i/e/i$e;->setLargeIcon(Landroid/graphics/Bitmap;)Lb/i/e/i$e;

    .line 3
    new-instance v2, Lb/i/e/i$b;

    invoke-direct {v2}, Lb/i/e/i$b;-><init>()V

    invoke-virtual {v2, v1}, Lb/i/e/i$b;->h(Landroid/graphics/Bitmap;)Lb/i/e/i$b;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Lb/i/e/i$b;->g(Landroid/graphics/Bitmap;)Lb/i/e/i$b;

    move-result-object v1

    invoke-virtual {p1, v1}, Lb/i/e/i$e;->setStyle(Lb/i/e/i$f;)Lb/i/e/i$e;
    :try_end_0
...
.method public handleNotification()Z
    ...
    iget-object v3, v2, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;->notificationBuilder:Lb/i/e/i$e;

    .line 5
    invoke-direct {p0, v3, v0}, Lcom/google/firebase/messaging/DisplayNotification;->waitForAndApplyImageDownload(Lb/i/e/i$e;Lcom/google/firebase/messaging/ImageDownload;)V
