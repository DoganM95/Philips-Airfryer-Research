.class public Lcom/philips/connectivity/condor/lan/discovery/MDNSDiscoveryStrategy;
.super Lcom/philips/connectivity/condor/lan/discovery/BaseLanDiscoveryStrategy;
.source "MDNSDiscoveryStrategy.java"
...
.method public handleDiscoveryStateChanged()V
    ...
    :cond_1
    const-string v1, "mDNS discovery started."
    ...
    const-string v6, "Error starting mDNS Discovery mechanism: "
    ...
    :cond_5
    :goto_3
    const-string v0, "mDNS Discovery stopped."
