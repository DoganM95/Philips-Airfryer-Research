...
.method constructor <init>(Lretrofit2/ServiceMethod$Builder;)V
    ...
    invoke-virtual {v0}, Lretrofit2/Retrofit;->baseUrl()Lokhttp3/s;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/ServiceMethod;->baseUrl:Lokhttp3/s;
    ...
    .line 86
    iget-object v0, p1, Lretrofit2/ServiceMethod$Builder;->headers:Lokhttp3/r;

    iput-object v0, p0, Lretrofit2/ServiceMethod;->headers:Lokhttp3/r;
...
# virtual methods
.method varargs toRequest([Ljava/lang/Object;)Lokhttp3/z;
    .locals 10
    ...
    iget-object v2, p0, Lretrofit2/ServiceMethod;->baseUrl:Lokhttp3/s;

    iget-object v3, p0, Lretrofit2/ServiceMethod;->relativeUrl:Ljava/lang/String;

    iget-object v4, p0, Lretrofit2/ServiceMethod;->headers:Lokhttp3/r;
    ...
    invoke-direct/range {v0 .. v8}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lokhttp3/s;Ljava/lang/String;Lokhttp3/r;Lokhttp3/u;ZZZ)V
    ...
    .line 112
    :cond_2
    invoke-virtual {v0}, Lretrofit2/RequestBuilder;->build()Lokhttp3/z;
...
.method toResponse(Lokhttp3/ac;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
