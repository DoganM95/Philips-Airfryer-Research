...
destinationHost = "192.168.0.30"  # Use 239.255.255.250 as broadcast address
...
def discover_pnp_locations():
    ...
    sock.sendto(ssdpDiscover.encode("ASCII"), (destinationHost, 1900))
    sock.settimeout(3)
    try:
        while True:
        ...
        for location in locations:
            ...
            try:
                ...
                for service in services:
                    print(
                        "\t\t=> Service Type: %s" % service.find("./{urn:schemas-upnp-org:device-1-0}serviceType").text
                    )
...
def find_directories(p_url, p_service):
    ...
    soapActionHeader = {"Soapaction": '"' + p_service + "#Browse" + '"', "Content-type": 'text/xml;charset="utf-8"'}
